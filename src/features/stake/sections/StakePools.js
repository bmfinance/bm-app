        ...
        <Grid className={classes.faq} item xs={12} lg={9}>
          <Accordion square expanded={expanded === 'faq-1'} onChange={handleChange('faq-1')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>How do I use Bm Launchpool?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <img
                ...
                to the related partner Launchpool vault here on the Bm Launchpool site and enter
          ...
          <Accordion square expanded={expanded === 'faq-7'} onChange={handleChange('faq-7')}>
            ...
            <AccordionDetails>
              <Typography>
                Once you stake in any of Bm Finance vaults, you get in return something called
          ...
          <Accordion square expanded={expanded === 'faq-9'} onChange={handleChange('faq-9')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                rate” and is a fixed rate. Bm shows APR by dividing the annual yield into 365
                days and presents that to you as “Daily”. APY on the other hand means “Annual
                percentage yield” which is when you take the daily yield and compound it. Bm
          ...
          <Accordion square expanded={expanded === 'faq-11'} onChange={handleChange('faq-11')}>
            ...
            <AccordionDetails>
              <Typography>
                Yes! These partner vaults are hosted by Bm and are completely safe. Bm have
                gotten tokens from our partners and use our own vaults for the reward. Those
                mooTokens you stake doesn’t leave Bm.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </Grid>
