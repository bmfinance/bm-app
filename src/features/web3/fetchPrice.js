...
const endpoints = {
  bakery: `https://api.bm.finance/bakery/price?_=${process.env.VERCEL_GIT_COMMIT_SHA}`,
  coingecko: 'https://api.coingecko.com/api/v3/simple/price',
  pancake: `https://api.bm.finance/pancake/price?_=${process.env.VERCEL_GIT_COMMIT_SHA}`,
  lps: `https://api.bm.finance/lps?_=${process.env.VERCEL_GIT_COMMIT_SHA}`,
};
